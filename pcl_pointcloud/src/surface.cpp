...
private:
    ...
    void topic_callback(const sensor_msgs::msg::PointCloud2::SharedPtr msg)
    {
        ...
        tree->setInputCloud(cloud_filtered4);
        ...
        pcl::concatenateFields(*cloud_filtered4, *normals, *cloud_with_normals);

        // 曲面重建
        pcl::GreedyProjectionTriangulation<pcl::PointNormal> gp3;
        pcl::PolygonMesh triangles;
        gp3.setSearchRadius(0.025); // 示例值
        gp3.setMu(2.5);
        ...
        // 保存重建的网格
        pcl::io::savePLYFile("/home/foxy/ros2_deeyea_final/mesh.ply", triangles);
        RCLCPP_INFO(this->get_logger(), "Mesh saved.");
