...
private:
    ...
    void topic_callback(const sensor_msgs::msg::PointCloud2::SharedPtr msg)
    {
        ...
        // pcl::PointCloud<pcl::PointXYZ>::Ptr uniformResult(new pcl::PointCloud<pcl::PointXYZ>);
        // uniform_sampling.filter(*cloud_filtered1);
        ...
        cloud_viewer_.showCloud(cloud_filtered4);
